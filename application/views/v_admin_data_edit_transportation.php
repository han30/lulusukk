      ...
      <section class="content">
        <div class="row">
          ...
          <div class="box">
              ...
              <!-- /.box-header -->
              <div class="box-body">
              <?php foreach ($tb_transportation as $u) {
            ...
            <form  action=<?php echo base_url("crud/update_transportation"); ?> method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="code" value=<?php echo $u->code;?> />
                </div>
                 <div class="form-group">
                  <label>Description</label>
                  <input type="text" class="form-control" name="description"  value=<?php echo $u->description;?> />
                </div>
                  <div class="form-group">
                  <label >Seat QTY</label>
                  <input type="text" class="form-control" name="seat_qty" value=<?php echo $u->seat_qty;?> />
                </div>
                  <div class="form-group">
                  <label >Transport Type Id</label>
                  <input type="text" class="form-control" name="transportation_type_id" value=<?php echo $u->transportation_type_id;?> />
                </div>
              </div>
              <!-- /.box-body -->
