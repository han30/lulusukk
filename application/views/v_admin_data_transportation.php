                ...
                <table id="data_user" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $u->transportation_type_id; ?></td>
                      <td>
                        <a href=<?php echo base_url("crud/edit_transportation/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                          <span><strong>Edit</strong></span>            
                        </a>
                        <a href=<?php echo base_url("crud/hapus_transportation/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
