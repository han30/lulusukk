            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="data_user" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php  foreach ($tb_transportation_type as $u) { ?>
                    <tr>
                      <td><?php echo $u->id; ?></td>
                      <td><?php echo $u->description; ?></td>
                      <td>
                        <a href=<?php echo base_url("crud/edit_transportation_type/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                          <span><strong>Edit</strong></span>            
                        </a>
                        <a href=<?php echo base_url("crud/hapus_transportation_type/".$u->id); ?> class="btn btn-primary a-btn-slide-text">
